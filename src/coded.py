...
def coded_logistic_regression(n_procs, n_samples, n_features, input_dir, n_stragglers, is_real_data, params):
    ...
    if rank==0:
        ...
        save_vector(training_loss, os.path.join(output_dir, f"coded_acc_{n_stragglers}_training_loss_{timestamp}.dat"))
        save_vector(testing_loss, os.path.join(output_dir, f"coded_acc_{n_stragglers}_testing_loss_{timestamp}.dat"))
